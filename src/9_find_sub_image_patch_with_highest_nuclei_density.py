...
def get_target_image_patch_path(all_image_patch_paths_for_specific_image_mode, target_image_patch_metadata_object):
    for image_patch_path in all_image_patch_paths_for_specific_image_mode:
        ...
        image_patch_metadata_object_ = image_patch_metadata_object.image_patch_metadata_object_from_image_patch_dict(
            patch_file_name_to_dict)

        isMatch = image_patch_metadata_object_.x_coordinate == target_image_patch_metadata_object.x_coordinate and image_patch_metadata_object_.y_coordinate == target_image_patch_metadata_object.y_coordinate
        if isMatch:
...
path_utils.halt_script_if_path_does_not_exist(image_patches_with_nuclei_counts_path)
...
case_directory_paths = path_utils.create_full_paths_to_directories_in_directory_path(image_patches_with_nuclei_counts_path)
