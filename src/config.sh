...
# 10_label_image_patches_with_gene_mutation
#####################################
S10_LABEL_IMAGE_PATCHES_WITH_GENE_MUTATION_INPUT_DIRECTORY_PATH=${S9_FIND_SUB_IMAGE_PATCH_WITH_HIGHEST_NUCLEI_DENSITY_OUTPUT_DIRECTORY_PATH}
S10_LABEL_IMAGE_PATCHES_WITH_GENE_MUTATION_OUTPUT_DIRECTORY_PATH="${S0_OUTPUT_DIRECTORY_PATH}/10_label_image_patches_with_gene_mutation"
S10_LABEL_IMAGE_PATCHES_WITH_GENE_MUTATION_MUTATION_FILE_PATH="${S0_INPUT_DIRECTORY_PATH}/tcga_mutation_file"
S10_LABEL_IMAGE_PATCHES_WITH_GENE_MUTATION_GENE_OF_INTEREST="SPOP"
S10_LABEL_IMAGE_PATCHES_WITH_GENE_MUTATION_DISC_OPERATION="copy" #move or copy
S10_LABEL_IMAGE_PATCHES_WITH_GENE_MUTATION_DIRECTORY_TO_DELETE=${S9_FIND_SUB_IMAGE_PATCH_WITH_HIGHEST_NUCLEI_DENSITY_OUTPUT_DIRECTORY_PATH}